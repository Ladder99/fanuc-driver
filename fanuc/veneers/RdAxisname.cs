...
namespace l99.driver.fanuc.veneers
{
    ...
    {
        public RdAxisname(Veneers veneers, string name = "", bool isCompound = false, bool isInternal = false) : base(veneers, name, isCompound, isInternal)
        {
        ...
        protected override async Task<dynamic> AnyAsync(dynamic[] nativeInputs, dynamic[] additionalInputs)
        {
            if (nativeInputs.All(o => o.success == true))
            {
                ...
                for (int x = 0; x <= nativeInputs[0].response.cnc_rdaxisname.data_num - 1; x++)
                {
