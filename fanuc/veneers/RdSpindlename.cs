...
{
    public RdSpindlename(Veneers veneers, string name = "", bool isCompound = false, bool isInternal = false) : base(
    ...
    protected override async Task<dynamic> AnyAsync(dynamic[] nativeInputs, dynamic[] additionalInputs)
    {
        if (nativeInputs.All(o => o.success == true))
        {
            ...
            for (var x = 0; x <= nativeInputs[0].response.cnc_rdspdlname.data_num - 1; x++)
            {
