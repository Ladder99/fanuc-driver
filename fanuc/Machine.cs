...
namespace fanuc
{
    public class Machine
    {
        ...
        private int _focasPort = 8193;
        private int _connectionTimeout = 3;

        private ushort _handle; // Fanuc Controller 32i/Oi-TD/16i-MB/18i-TB/Oi-MC/Oi-TC/Oi-MD/Oi-MC Slim/21i-TB/310iM

        public Machine(string focasIpAddress, int focasPort = 8193, int timeout = 10)
        {
        ...
        {
            Focas1.focas_ret rc = (Focas1.focas_ret)Focas1.cnc_allclibhndl3(_focasIpAddress, (ushort) _focasPort, _connectionTimeout, out _handle);
            ...
            return new
            {
                ...
                rc,
                request = new { cnc_allclibhndl3 = new { ipaddr = _focasIpAddress, port = _focasPort, timeout = _connectionTimeout } },
