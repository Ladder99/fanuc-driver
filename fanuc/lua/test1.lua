...
function script:collect_root(this, collector)
    ...
    print("--- p1 ---");
    p1 = collector.Platform:RdParamDoubleWordNoAxisAsync(6750).Result;
    print(collector:to_json(p1));
    
    print("--- p2_1 ---");
    p2_1 = collector:set("p2", collector.Platform:RdParamDoubleWordNoAxisAsync(6750).Result);
    ...
    print("--- p3_1 ---");
    p3_1 = collector:set_native("p3", collector.Platform:RdParamDoubleWordNoAxisAsync(6750).Result);
    ...
    print("--- p4 ---");
    p4 = collector:set_native_and_peel("v1", collector.Platform:RdParamDoubleWordNoAxisAsync(6750).Result);
    print(p4);
    --print(collector:to_json(p4)); -- TODO: self referencing loop
    
    print("--- p5 ---");
    p5 = collector:peel("v2", collector:set_native("p3", collector.Platform:RdParamDoubleWordNoAxisAsync(6750).Result));
    print(p5);
