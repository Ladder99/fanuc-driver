...
{
    public SpindleData(FanucMultiStrategy strategy, object configuration) : base(strategy, configuration)
    {
    }

    public override async Task InitSpindleAsync()
    {
        await Strategy.Apply(typeof(veneers.SpindleData), "spindle", true);
    }
    ...
    public override async Task CollectForEachSpindleAsync(short currentPath, short currentSpindle, string spindleName,
